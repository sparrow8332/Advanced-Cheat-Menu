...
-- Italian --------------------------------------------------------------------------------------------------
		("LOC_CHEAT_MENU_ABOUT",  					"it_IT",		"Pannello Trucchi di [Sparrow]"),
		("LOC_CHEAT_MENU_FREECITY",  				"it_IT",		"Rendi la Città selezionata una Città LIBERA"),
		("LOC_CHEAT_EXPAND_MAX",  					"it_IT",		"Nascondi Pannello Avanzato"),
		("LOC_CHEAT_COLLAPSE_MAX",  				"it_IT",		"Mostra Pannello Avanzato"),
		("LOC_FORM_ARMY",  							"it_IT",		"Forma un'esercito/armata con l'unità selezionata"),
		("LOC_FORM_CORPS",  						"it_IT",		"Forma un corpo/flotta con l'unità selezionata"),
		("LOC_CHEAT_MENU_DIPLOMATIC_FAVOR", 		"it_IT",		"Aggiungi +100  Favore Diplomatico"),
		("LOC_CHEAT_MENU_HEADER",  					"it_IT",		"PANNELLO TRUCCHI"),
		("LOC_CHEAT_TOGGLE_MENU",  					"it_IT",		"Attiva/Disattiva Pannello Trucchi"),
		("LOC_CHEAT_ICON",  						"it_IT",		"Menu Trucchi di Sparrow"),
		("LOC_CHEAT_MENU_GOVPOINTS",  				"it_IT",		"Aggiungi +1 Punto Titolo Governatore"),
		("LOC_CHEAT_MENU_CheatResourcesLux",  		"it_IT",		"Aggiungi un numero casuale fra 1-3 a tutte le Risorse DI LUSSO"),
		("LOC_CHEAT_MENU_CheatResourcesStr",  		"it_IT",		"Aggiungi un numero casuale fra 1-3 a tutte le Risorse STRATEGICHE"),
		("LOC_CHEAT_MENU_CheatResourcesBonus",  	"it_IT",		"Aggiungi un numero casuale fra 1-3 a tutte le Risorse BONUS"),
		("LOC_CHEAT_MENU_GOLD",  					"it_IT",		"Aggiungi +1000 [ICON_Gold]"),
		("LOC_CHEAT_MENU_PRODUCTION",  				"it_IT",		"Completa la [ICON_Production] attuale nella Città Selezionata"),
		("LOC_CHEAT_MENU_SCIENCE",  				"it_IT",		"Completa la Ricerca Scientifica [ICON_Science] attuale"),
		("LOC_CHEAT_MENU_CULTURE",  				"it_IT",		"Completa la Ricerca Civica [ICON_Culture] attuale"),
		("LOC_CHEAT_MENU_FAITH",  					"it_IT",		"Aggiungi +1000 [ICON_Faith]"),
		("LOC_CHEAT_MENU_ENVOY",  					"it_IT",		"Aggiungi +5 [ICON_Envoy] Emissari"),
		("LOC_CHEAT_MENU_ERA",  					"it_IT",		"Aumenta +10 Punti Epoca"),
		("LOC_CHEAT_MENU_ERAMINUS",  				"it_IT",		"Diminuisci -10 Punti Epoca"),
		("LOC_CHEAT_MENU_MOVE",  					"it_IT",		"Aggiungi +5  Movimenti all'Unità Selezionata"),
		("LOC_CHEAT_MENU_XP",  						"it_IT",		"Promuovi l'Unità Selezionata"),
		("LOC_CHEAT_MENU_HEAL",  					"it_IT",		"Guarisce l'Unità Selezionata"),
		("LOC_CHEAT_MENU_MOVES",  					"it_IT",		"Ripristina il Movimento [ICON_Movement] dell'Unità"),
		("LOC_CHEAT_MENU_DUPLICATE",  				"it_IT",		"Duplica l'Unità Selezionata"),
		("LOC_CHEAT_MENU_POP",  					"it_IT",		"Aggiungi +1 [ICON_Citizen] alla Città Selezionata"),
		("LOC_CHEAT_MENU_LOYALTY",  				"it_IT",		"Aggiungi +100  Fedeltà alla Città Selezionata"),
		("LOC_CHEAT_MENU_DESTROY",  				"it_IT",		"Distruggi Città"),
		("LOC_CHEAT_MENU_CITYHEAL",  				"it_IT",		"Ripara la GUARNIGIONE & MURA ESTERNE della Città"),
		("LOC_CHEAT_MENU_AllTECH",  				"it_IT",		"Tut. [ICON_Science]"),
		("LOC_CHEAT_MENU_AllCIVIC",  				"it_IT",		"Tut. [ICON_Culture]"),
		("LOC_CHEAT_MENU_AllTECH_TOOLTIP",  		"it_IT",		"Completa Tutto [ICON_Science]"),
		("LOC_CHEAT_MENU_AllCIVIC_TOOLTIP",  		"it_IT",		"Completa Tutto [ICON_Culture]"),
		("LOC_CHEAT_MENU_OBVS",  					"it_IT",		"Attiva l'Opzione Osserva Mappa"),
		("LOC_DESTROY_CITY_HEADER",  				"it_IT",		"Radi al Suolo la Città Selezionata"),
		("LOC_DESTROY_CITY_DISTRICTS_LABEL",  		"it_IT",		"Distretti:"),
		("LOC_RAZE_CITY_EXPLANATION",				"it_IT",		"Radi al suolo la città con i suoi distretti e le sue costruzioni."),
		("LOC_KEEP_CITY_EXPLANATION",				"it_IT",		"Tieni questa città nel tuo Impero per adesso."),
		("LOC_DESTROY_CITY_LIBERATE_EXPLANATION",	"it_IT",		"Liberare una Città la farà tornare ad uno dei suoi precedenti proprietari, riportando probabilmente la civiltà in gioco."),
