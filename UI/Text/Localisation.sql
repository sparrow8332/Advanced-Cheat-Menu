...
-- Italian --------------------------------------------------------------------------------------------------
		...
		("LOC_FORM_ARMY",  							"it_IT",		"Forma un'armata con l'unità selezionata"),
		("LOC_FORM_CORPS",  						"it_IT",		"Forma una flotta con l'unità selezionata"),
		("LOC_CHEAT_MENU_DIPLOMATIC_FAVOR", 		"it_IT",		"Aggiunge +100 favore diplomatico"),
		("LOC_CHEAT_TOGGLE_MENU", 					"it_IT", 		"Attiva Pannello Trucchi"),
		("LOC_CHEAT_ICON", 							"it_IT",		"Menu Trucchi di Sparrow"),
		("LOC_CHEAT_MENU_GOVPOINTS", 				"it_IT",		"Aggiunge +1 punto titolo del governatore"),
		("LOC_CHEAT_MENU_GOLD", 					"it_IT", 		"Aggiunge +1000 [ICON_Gold]"),
		("LOC_CHEAT_MENU_PRODUCTION", 				"it_IT", 		"Completa la [ICON_Production] corrente nella città selezionata"),
		("LOC_CHEAT_MENU_SCIENCE", 					"it_IT", 		"Completa la ricerca scientifica [ICON_Science] attuale"),
		("LOC_CHEAT_MENU_CULTURE", 					"it_IT", 		"Completa lo sviluppo civico [ICON_Culture] attuale"),
		("LOC_CHEAT_MENU_FAITH", 					"it_IT", 		"Aggiunge +1000 [ICON_Faith]"),
		("LOC_CHEAT_MENU_ENVOY", 					"it_IT",		"Aggiunge +5 [ICON_Envoy] Emissario"),
		("LOC_CHEAT_MENU_ERA", 						"it_IT", 		"Aggiunge +10 punti epoca"),
		("LOC_CHEAT_MENU_MOVE", 					"it_IT",		"Aggiungi +5 movimento all'unità selezionata"),
		("LOC_CHEAT_MENU_XP", 						"it_IT", 		"Promuove l'unità selezionata"),
		...
		("LOC_CHEAT_MENU_AllTECH", 					"it_IT", 		"Compl. tutto [ICON_Science]"),
		("LOC_CHEAT_MENU_AllCIVIC", 				"it_IT", 		"Compl. tutto [ICON_Culture]"),
		("LOC_CHEAT_MENU_OBVS", 					"it_IT", 		"Attiva/Disattiva 'osserva mappa'"),
		...
		("LOC_DESTROY_CITY_LIBERATE_EXPLANATION", 	"it_IT", 		"Liberare una città la restituirà a uno dei suoi precedenti proprietari, riportando probabilmente la civiltà in gioco."),
