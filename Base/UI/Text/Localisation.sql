...
VALUES
-- English US ------------------------------------------------------------------------------------------------------------
		("LOC_CHEAT_MENU_PANEL",  					"en_US",		"Cheat Panel"),
		...
		("LOC_CHEAT_MENU_HEADER",  					"en_US",		"[ICON_Capital] CHEAT PANEL ADVANCED [ICON_Capital]"),
		...
		("LOC_CHEAT_MENU_CheatResourcesLux",  		"en_US",		"Adds Random number between 1-3 of ALL LUXURY Resources"),
		("LOC_CHEAT_MENU_CheatResourcesStr",  		"en_US",		"Adds Random number between 1-3 of ALL STRATEGIC Resources"),
		("LOC_CHEAT_MENU_CheatResourcesBonus",  	"en_US",		"Adds Random number between 1-3 of ALL BONUS Resources"),
		...
		("LOC_CHEAT_MENU_Builder_TOOLTIP",  		"en_US",		"Spawn a free Builder"),
		("LOC_CHEAT_MENU_Settler_TOOLTIP",  		"en_US",		"Spawn a free Settler"),
...
-- Italian --------------------------------------------------------------------------------------------------
		...
		("LOC_CHEAT_MENU_HEADER",  					"it_IT",		"CHEAT PANEL"),
...
-- Chinese (simplified)---------------------------------------------------------------------------------------------------------------
		("LOC_CHEAT_MENU_ABOUT",  					"zh_Hans_CN",	"由 [Sparrow] 提供的修改器面板"),
		("LOC_CHEAT_EXPAND_MAX",  					"zh_Hans_CN",	"隐藏高级面板"),
		("LOC_CHEAT_COLLAPSE_MAX",  				"zh_Hans_CN",	"显示高级面板"),
		("LOC_CHEAT_MENU_ChangeResources",  		"zh_Hans_CN",	"加+10 [NEWLINE][ICON_RESOURCE_IRON] 铁[NEWLINE][ICON_RESOURCE_COAL] 煤[NEWLINE][ICON_RESOURCE_URANIUM] 轴[NEWLINE][ICON_RESOURCE_ALUMINUM] 铝[NEWLINE][ICON_RESOURCE_OIL] 石油[NEWLINE][ICON_RESOURCE_NITER] 硝石"),
		("LOC_FORM_ARMY",  							"zh_Hans_CN",	"所选单位升级为军队"),
		("LOC_FORM_CORPS",  						"zh_Hans_CN",	"所选单位升级为军团"),
		("LOC_CHEAT_MENU_DIPLOMATIC_FAVOR", 		"zh_Hans_CN",	"+100 外交支持"),
		("LOC_CHEAT_TOGGLE_MENU",					"zh_Hans_CN",	"显示或隐藏修改器面板"),
		("LOC_CHEAT_ICON",							"zh_Hans_CN",	"由 [Sparrow] 提供的修改器面板"),
		("LOC_CHEAT_MENU_GOVPOINTS",				"zh_Hans_CN",	"+1 总督点数"),
		("LOC_CHEAT_MENU_GOLD",						"zh_Hans_CN",	"+1000 金币 [ICON_Gold]"),
		("LOC_CHEAT_MENU_PRODUCTION",				"zh_Hans_CN",	"所选城市完成当前建造"),
		("LOC_CHEAT_MENU_SCIENCE",					"zh_Hans_CN",	"完成当前科技研究"),
		("LOC_CHEAT_MENU_CULTURE",					"zh_Hans_CN",	"完成当前市政研究"),
		("LOC_CHEAT_MENU_FAITH",					"zh_Hans_CN",	"+1000 信仰 [ICON_Faith]"),
		("LOC_CHEAT_MENU_CITYHEAL",  				"zh_Hans_CN",	"恢复所选城市生命值及城防"),
		("LOC_CHEAT_MENU_ENVOY",					"zh_Hans_CN",	"+5 使者"),
		("LOC_CHEAT_MENU_ERA",						"zh_Hans_CN",	"+10 时代得分"),
		("LOC_CHEAT_MENU_ERAMINUS",  				"zh_Hans_CN",	"-10 时代得分"),
		("LOC_CHEAT_MENU_MOVE",						"zh_Hans_CN",	"所选单位 +5 移动力"),
		("LOC_CHEAT_MENU_XP",						"zh_Hans_CN",	"所选单位升 1 级"),
		("LOC_CHEAT_MENU_HEAL",						"zh_Hans_CN",	"恢复单位生命值"),
		("LOC_CHEAT_MENU_MOVES",					"zh_Hans_CN",	"所选单位恢复移动力+攻击力"),
		("LOC_CHEAT_MENU_DUPLICATE",				"zh_Hans_CN",	"复制所选的单位（不适用于伟人和宗教单位）"),
		("LOC_CHEAT_MENU_POP",						"zh_Hans_CN",	"所选城市 +1 人口"),
		("LOC_CHEAT_MENU_LOYALTY",					"zh_Hans_CN",	"所选城市 +100 忠诚度"),
		...
		("LOC_CHEAT_MENU_OBVS",						"zh_Hans_CN",	"开/关打开全图"),
		...
		("LOC_CHEAT_MENU_PANEL",  					"zh_Hans_CN",	"修改器面板"),
		("LOC_CHEAT_MENU_HEADER",  					"zh_Hans_CN",	"[ICON_Capital] 修改器面板 高级版 [ICON_Capital]"),
		("LOC_CHEAT_MENU_CheatResourcesLux",  		"zh_Hans_CN",	"随机增加 1-3 所有奢侈品资源"),
		("LOC_CHEAT_MENU_CheatResourcesStr",  		"zh_Hans_CN",	"随机增加 1-3 所有战略资源"),
		("LOC_CHEAT_MENU_CheatResourcesBonus",  	"zh_Hans_CN",	"随机增加 1-3 所有额外资源"),
		("LOC_CHEAT_MENU_FREECITY",  				"zh_Hans_CN",	"解放所选城市"),
		("LOC_CHEAT_MENU_AllTECH_TOOLTIP",  		"zh_Hans_CN",	"完成所有科技研究 [ICON_Science]"),
		("LOC_CHEAT_MENU_AllCIVIC_TOOLTIP",  		"zh_Hans_CN",	"完成所有市政研究 [ICON_Culture]"),
		("LOC_CHEAT_MENU_Builder_TOOLTIP",  		"zh_Hans_CN",	"生成一个免费的建造者"),
		("LOC_CHEAT_MENU_Settler_TOOLTIP",  		"zh_Hans_CN",	"生成一个免费的开拓者"),
-- Japanese ------------------------------------------------------------------------------------------------------------
